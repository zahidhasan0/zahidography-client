...
const Register = () => {
  const [currectPassword, setCorrectPassword] = useState("");
  const { handleRegister, user } = useContext(AuthProvider);
  ...
  const register = (event) => {
    ...
    console.log(email, password, currectPassword);
    handleRegister(email, currectPassword)
      .then((result) => {
  ...
  return (
    <form onSubmit={register} className="w-1/2 border-2 p-4 mx-auto ">
